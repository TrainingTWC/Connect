    ...
    <div className="p-4 bg-slate-900/50 border-t border-slate-700/50 flex items-center justify-between">
      ...
      <div>
        {(status === 'idle' || status === 'finished') && (
          <button onClick={onStart} className="px-4 py-2 bg-sky-600 text-white rounded-lg font-semibold hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-opacity-50 transition-colors flex items-center space-x-2">
